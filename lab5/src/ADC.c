...
int main ()
{
	...
	while (1)
	{
        ...
        float reg = ADCvalue/4.3*3.3;
        reg /= 1000000000;
        
        LCD_putchar(0x30 + ((int)reg/1%10)); // 1st num
        DelayMsec(5);
        
        LCD_putchar(0x2e); ///.
        DelayMsec(5);
        
        LCD_putchar(0x30 + ((int)(reg*10)/1%10)); // 2nd num
        DelayMsec(5);
        
        LCD_putchar(0x30 + ((int)(reg*100)/1%10)); // 3rd num
        DelayMsec(5);
        
        LCD_putchar(0x56);// 4th V 
        DelayMsec(5);
